...
func newMolStore(t *testing.T) *issueservice.IssueStore {
	t.Helper()
...
func buildTestMolecule(t *testing.T, ctx context.Context, s *issueservice.IssueStore) (root *issuestorage.Issue, children map[string]*issuestorage.Issue) {
	t.Helper()
